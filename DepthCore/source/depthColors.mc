...
module DepthCore {
    ...
    //! the reading can be judged without actually reading the number. The
    //! thresholds are in meters regardless of the display unit, because they
    //! describe the physical depth.
    (:glance)
