...
class depth_chartApp extends Application.AppBase {

    // Held so a settings change can be pushed into the running field.
    private var _view as depth_chartView?;
...
function getApp() as depth_chartApp {
    return Application.getApp() as depth_chartApp;
}
