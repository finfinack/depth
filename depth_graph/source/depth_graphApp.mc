...
class depth_graphApp extends Application.AppBase {

    // Held so a settings change can be pushed into the running field.
    private var _view as depth_graphView?;
...
function getApp() as depth_graphApp {
    return Application.getApp() as depth_graphApp;
}
